...
- *프리셋 목록* — 등록한 프리셋 이름들. 클릭하면 즉시 적용, 현재 프리셋에 ✓ 표시. 활성 프리셋을 다시 클릭하면 해제
- **Settings...** — 프리셋 관리 및 일반 설정 창 (⌘,)
...
2. **Presets** 탭에서 **+** 버튼으로 새 프리셋을 추가합니다
